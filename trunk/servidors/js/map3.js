...
function updateEstat() {                
                var url = "mihizawi.redirectme.net/JavaBridge/estat";
...
function updatePosicions() {
                var url = "mihizawi.redirectme.net/JavaBridge/posicions";
...
function enviarAssignacio(atributs) {
                ...
                var url_base = "mihizawi.redirectme.net/JavaBridge/asign_uni_web";
...
function enviaNovaIncidencia(lat,ln,descr) {
        var url_base = "mihizawi.redirectme.net/JavaBridge/new_inc_web";
